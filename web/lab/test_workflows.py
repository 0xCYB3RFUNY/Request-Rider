...
class WorkflowApiTests(TransactionTestCase):
    ...
    def test_repeater_burst_is_bounded_parallel_orchestration(self, call_engine_get, call_engine):
        ...
        call_engine_get.return_value = (200, {"burst_id": 9, "status": "completed", "total": 3, "completed": 3, "failed": 0, "results": [{"iteration": 0, "status": 200, "body": "ok", "headers": {}, "time": 1, "size": 2}]})
        ...
        call_engine_get.assert_called_once_with("/proxy/repeater-burst/9", timeout=5)
    ...
    def test_last_byte_sync_runs_and_persists_completed_evidence(self, call_engine, call_engine_get):
        ...
        call_engine_get.assert_called_once_with("/proxy/last-byte/17", timeout=5)
